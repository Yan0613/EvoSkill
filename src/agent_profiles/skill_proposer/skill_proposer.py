...
def _make_skill_proposer_options() -> Union[Any, dict]:
    """Factory function that creates agent options for skill proposer.
    ...
    if not is_claude_sdk():
        ...
        vllm_system = tool_calling_preamble + SKILL_PROPOSER_SYSTEM_PROMPT.strip()
        return {
            "system": vllm_system,
            "tools": HF_TOOLS,
            "model_id": "",
